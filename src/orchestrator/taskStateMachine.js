...
const TRANSITIONS = Object.freeze({
  [TASK_STATES.PENDING]: new Set([TASK_STATES.RUNNING, TASK_STATES.WAITING_FOR_AUTH, TASK_STATES.FAILED, TASK_STATES.CANCELLED]),
  [TASK_STATES.RUNNING]: new Set([TASK_STATES.WAITING_FOR_AUTH, TASK_STATES.WAITING_HUMAN, TASK_STATES.SUCCEEDED, TASK_STATES.FAILED, TASK_STATES.TIMED_OUT, TASK_STATES.CANCELLED]),
  [TASK_STATES.WAITING_FOR_AUTH]: new Set([TASK_STATES.RUNNING, TASK_STATES.WAITING_HUMAN, TASK_STATES.FAILED, TASK_STATES.TIMED_OUT, TASK_STATES.CANCELLED]),
  [TASK_STATES.WAITING_HUMAN]: new Set([TASK_STATES.RUNNING, TASK_STATES.WAITING_FOR_AUTH, TASK_STATES.FAILED, TASK_STATES.TIMED_OUT, TASK_STATES.CANCELLED]),
